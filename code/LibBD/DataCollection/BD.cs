...
namespace LibBD
{
...

    {
        ...
        public abstract bool create(string table, List<DataCollection> data, int id);
        ...
        // public abstract List<object> read(List<string> fields, string table, List<SearchCollection> search);  
        public abstract List<object> index(List<string> fields, string table, List<SearchCollection> search);
        /// <summary>
